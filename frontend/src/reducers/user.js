      ...
      .then((data) => {
        if (data.success) {
          batch(() => {
            ...
            dispatch(
              user.actions.setFirstName(data.response.firstName)
            );
            dispatch(
              user.actions.setLastName(data.response.lastName)
            );
            dispatch(
              user.actions.setDescription(data.response.description)
            );
            ...
            dispatch(
              user.actions.setCreatedAt(data.response.createdAt)
            );
            dispatch(
